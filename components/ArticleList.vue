...
<template>
  <div class="content" ref="scrollBar">
    <div class="content-nav">
      <div>
        <NuxtLink @click="changeArticle" to="?" class="tab-link">推荐</NuxtLink>
      </div>
      <div>
        <NuxtLink to="?sort=new" @click="changeArticle('new')" class="tab-link">最新</NuxtLink>
      </div>
      <div style="border-right: none;">
        <NuxtLink to="?sort=hot" @click="changeArticle('hot')" class="tab-link">热榜</NuxtLink>
      </div>
    </div>
    ...
    <div ref="list">
      <div class="content-body" v-for="(item, index) in articles1" :key="index">
        <div class="list-tab">
          <span class="tad-write">{{ item.author.name }} | {{ computeTime(item.createdAt) }} <span
              v-for="(item, index) in item.tags.data" :key="index">| {{ item.tittle }}</span></span>
        </div>
          ...
          <div class="head-content">
            ...
            <div class="bottom-tab">
              <div class="bottom-see">
                <svg t="1677457805402" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="1947" width="16" height="16">
                  <path
              ...
              <div class="bottom-good">
                <svg t="1677458374711" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="3054" width="16" height="16">
                  <path
                    ...
                    p-id="3055" fill="#707070"></path>
                </svg>
                <span>{{item.good}}</span>
            </div>
            <div class="bottom-good">
              <svg t="1677636028466" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="6601" width="16" height="16">
                <path
                  ...
                  p-id="6602" fill="#5e6d82"></path>
                <path d="M321.536 512m-55.296 0a5.4 5.4 0 1 0 110.592 0 5.4 5.4 0 1 0-110.592 0Z" p-id="6603"
                  fill="#5e6d82"></path>
                <path d="M527.36 512m-55.296 0a5.4 5.4 0 1 0 110.592 0 5.4 5.4 0 1 0-110.592 0Z" p-id="6604"
                  fill="#5e6d82"></path>
                <path d="M733.184 512m-55.296 0a5.4 5.4 0 1 0 110.592 0 5.4 5.4 0 1 0-110.592 0Z" p-id="6605"
                  fill="#5e6d82"></path>
              </svg>
