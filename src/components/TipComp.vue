...
<div class="tips">
    ...
    <div class="tip-footer">
        <div class="foot-div">
            <NuxtLink to="https://lf3-cdn-tos.draftstatic.com/obj/ies-hotsoon-draft/juejin/86857833-55f6-4d9e-9897-45cfe9a42be4.html" class="foot-span">用户协议</NuxtLink>
            <NuxtLink to="https://juejin.cn/license" class="foot-span">营业执照</NuxtLink>
            <NuxtLink to="https://lf3-cdn-tos.draftstatic.com/obj/ies-hotsoon-draft/juejin/7b28b328-1ae4-4781-8d46-430fef1b872e.html" class="foot-span">隐私政策</NuxtLink>
        ...
        <div class="foot-div"><NuxtLink to="https://beian.miit.gov.cn/#/Integrated/index" class="foot-span" >京ICP备18012699号-3</NuxtLink></div>
        <div class="foot-police">
            <img width="19" height="19" src="https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/img/police.d0289dc.png" />
        ...
        <div class="foot-write">举报邮箱：<NuxtLink class="foot-span">feedback@xitu.io</NuxtLink></div>
        <div class="foot-juejin">©2023 稀土掘金</div>
        <div style="margin-top: 10px;">
            <img width="24" height="24" class="img-weibo" src="https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/img/weibo.0cd39f5.png" />
            <img width="24" height="24" class="img-chat" src="https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/img/wechat.ce329e6.png" />
        </div>
    </div>
</div>
